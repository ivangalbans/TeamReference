...
\pagebreak
  ...
  \section{General}
	  \includecpp{Template}{./General}{Template.cpp}
	  \includecpp{istringstream}{./General}{istringstream.cpp}
	  \includecpp{printf scanf}{./General}{printf_scanf.cpp}
...
\pagebreak
	...
	\section{Data Structures}
		...
		\includecpp{Longest Common Ancestor dp}{./Data_Structures}{LCA_dp.cpp}
		...
		\includecpp{Range Minimum Query I}{./Data_Structures}{RMQ-I.cpp}
		
		\includecpp{Range Minimum Query II}{./Data_Structures}{RMQ-II.cpp}
...
\pagebreak
  ...
  \section{Geometry}
    ...
    \includecpp{Polygons}{./Geometry}{Polygons.cpp}
